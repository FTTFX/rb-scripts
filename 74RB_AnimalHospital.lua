-- 74RB_AnimalHospital.lua — ESP + Speed + Noclip + AUTO รักษา + ฆ่าผี + ดับไฟ + ชัตเตอร์(ผีปิด/คนไข้เปิด)  (v2.8)
...
print("[74RB AnimalHospital v2.8] ESP + AUTO รักษา + Room6/8 + วาปทำเครื่อง + ดับไฟ + ชัตเตอร์(ผีปิด/คนไข้เปิด) พร้อม")
