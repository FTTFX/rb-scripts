...
**ลำดับความสำคัญ (v6.37, `busyBefore(rank)` จุดเดียว):** รักษา > ยิงผี > อุ้มคน > ดับไฟ > Hider > เช็คอิน/ซ่อมกล้อง > สไลม์ > กาแฟ/ซื้อของ/ชัตเตอร์ (ระบบช่วยคนโดนจับ ถอดออกแล้ว — ดิ้นเองด้วย Struggle prompt)
