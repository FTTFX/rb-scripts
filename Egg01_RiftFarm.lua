-- Egg01 Rift Farm v1.6 -- ต้องตั้ง HOME ก่อนเริ่ม เพื่อไม่กลับมือเปล่า
...
local function choosePrompt(t)
 ...
 if a and a.d<=4 and (not b or b.d-a.d>=1) then return a.p,a.d,"position" end
...
local title=Instance.new("TextLabel",f); title.Size=UDim2.new(1,-78,0,28); title.Position=UDim2.new(0,10,0,4); title.BackgroundTransparency=1; title.Text="Egg01 Rift Farm v1.6 — HOME REQUIRED"; title.TextColor3=Color3.fromRGB(220,170,255); title.Font=Enum.Font.GothamBold; title.TextSize=13; title.TextXAlignment=Enum.TextXAlignment.Left
